...
import { BaseAccordion, BaseCodeHighlight, BaseColorInput, BaseSelect, BaseStack, BaseSwitch, BaseText, BaseTextInput } from './components';

const classes = { properties: 'texo-tc-properties' };
              ...
              onChange={(value) =>
                updateConfig((current) => {
                  ...
                  return {
                    ...current,
                    primaryPalette:
                      primaryPalette as unknown as typeof current.primaryPalette,
                  };
                })
              }
            />

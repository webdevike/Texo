...
export const BaseCombobox: typeof Combobox = Combobox;
...
export const BaseFieldset: typeof Fieldset = Fieldset;
...
export const BaseTable: typeof Table = Table;
...
export const BasePinInput: typeof PinInput = PinInput;
